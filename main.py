...
<head>
    ...
    <title>Convertitore Foto in Word Gratis - OCR Online con Formattazione</title>
    <meta name="description" content="Converti gratuitamente foto e scansioni di documenti in file Word (.docx) mantenendo testo, font, dimensioni e formattazione con l'Intelligenza Artificiale.">
    <style>
...
<body>
    <div class="container">
        ...
        <p>Carica un'immagine o scatta una foto al tuo documento. Il nostro strumento AI estrarrà il testo mantenendo font, dimensioni e stili originali.</p>
